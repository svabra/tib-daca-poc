...
export const DATA_MODEL_ROUTES: Routes = [
  ...
  { path: 'model-reviews/:id', pathMatch: 'full', loadComponent: () => import('./logical-model-review.component').then((m) => m.LogicalModelReviewComponent), title: 'Modellprüfung | DaCa' },

...
export const POC_JOURNEYS: readonly PocJourney[] = [
  ...
  },
  {
    ...
    steps: [
      { title: 'Modell im armasuisse-Kontext erfassen', description: 'Mirjam öffnet den Editor und wählt VBS, Bundesamt für Rüstung armasuisse sowie armasuisse Immobilien. Beim Speichern zeigt der Editor unvollständige oder ungültige Felder direkt unter der Aktion an. I14Y-Concepts und I14Y-Wertelisten bleiben optional.', status: 'implemented', actions: [{ label: 'Modell als Mirjam erstellen', target: 'internal', path: '/models/new', demoUserId: 'mirjam.keller' }], checkpoint: 'Die Organisationskette stammt aus dem Staatskalender-Snapshot; ein vollständiger Entwurf lässt sich auch ohne I14Y-Auswahl speichern.' },

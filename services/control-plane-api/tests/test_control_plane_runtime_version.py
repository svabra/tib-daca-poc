...
from daca_control_plane import get_runtime_version
...
def test_image_version_drives_openapi_and_service_document(
    monkeypatch,
    ...
    with TestClient(application) as client:
        assert client.get("/").json()["version"] == "9.8.7-build.4"
